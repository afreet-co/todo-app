...
const Index = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-screen bg-dark-700 md:text-base text-sm">
      <div className="w-11/12 md:w-2/5 p-2 space-y-6 md:space-y-4">
        ...
        <form
          ...
          className="flex mt-4 mx-2 p-4 items-center bg-dark-600 rounded-lg md:rounded shadow-lg"
        >
          <CustomCheckbox
            checked={checked}
            controlId="check"
        ...
        <div className="mx-2 bg-dark-600 rounded-lg md:rounded shadow-lg px-5 md:px-4 py-5 md:py-3 block md:hidden">
